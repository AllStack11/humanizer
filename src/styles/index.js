export const S = {
  ...
  drawerOverlay: { position: "fixed", inset: 0, background: "rgba(26,18,8,0.2)", zIndex: 55 },
  drawerPanel: {
    position: "fixed",
    top: 0,
    right: 0,
  ...
  drawerHeader: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8 },
  drawerTitle: { margin: 0, fontSize: 16, fontFamily: "'Inter', sans-serif", color: "#3f3125" },
  drawerSection: { border: "1px solid #eee6da", borderRadius: 10, padding: 12, display: "flex", flexDirection: "column", gap: 10 },
  drawerLabel: { fontSize: 10, fontFamily: "'JetBrains Mono', monospace", letterSpacing: "0.13em", textTransform: "uppercase", color: "#8a7a6e" },
  drawerActions: { display: "flex", flexWrap: "wrap", gap: 8 },
  ...
  dangerGhostBtn: { background: "transparent", border: "1px solid #fecaca", borderRadius: 7, padding: "7px 14px", fontSize: 12, color: "#b91c1c", cursor: "pointer", fontFamily: "'Inter', sans-serif" },
